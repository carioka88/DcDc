function varargout = editEfficiency(varargin)
% EDITEFFICIENCY MATLAB code for editEfficiency.fig
%      EDITEFFICIENCY, by itself, creates a new EDITEFFICIENCY or raises the existing
%      singleton*.
%
%      H = EDITEFFICIENCY returns the handle to a new EDITEFFICIENCY or the handle to
%      the existing singleton*.
%
%      EDITEFFICIENCY('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in EDITEFFICIENCY.M with the given input arguments.
%
%      EDITEFFICIENCY('Property','Value',...) creates a new EDITEFFICIENCY or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before editEfficiency_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to editEfficiency_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help editEfficiency

% Last Modified by GUIDE v2.5 02-Dec-2013 10:38:32

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @editEfficiency_OpeningFcn, ...
                   'gui_OutputFcn',  @editEfficiency_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before editEfficiency is made visible.
function editEfficiency_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to editEfficiency (see VARARGIN)

% Choose default command line output for editEfficiency
...
% UIWAIT makes editEfficiency wait for user response (see UIRESUME)
...
function varargout = editEfficiency_OutputFcn(hObject, eventdata, handles) 
