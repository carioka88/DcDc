...
%Test always 0, because it has not been tested yet
%Channel 1, or 2...?

%values = {newModel{1}, 0, newModel{5}, 1};

%newModel(Model, Name, VIN, Iload, VOUT)

%insert(connection,'CONVERTER',{'NAME','MODEL','TEST','VOUT', 'CHANNEL'}, values);
